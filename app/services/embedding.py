...
class EmbeddingService:
    """
    Dịch vụ quản lý Dual Embedding (Dense E5-large + Sparse BM25).
    ...
    def __init__(self):
        ...
        logger.info("[EmbeddingService] Nạp toàn bộ mô hình Embedding thành công!")
    ...
    def warmup(self) -> None:
        ...
        """
        logger.info("[EmbeddingService] Đang chạy Warmup mô hình Embedding...")
